#!/usr/bin/env python3
"""Install (or remove) pi-reasoning-coalesce for pi.

Symlinks this directory to ~/.pi/agent/extensions/pi-reasoning-coalesce, where pi
...
TARGET = Path(os.environ.get("PI_AGENT_DIR", Path.home() / ".pi" / "agent")) / "extensions" / "pi-reasoning-coalesce"
